...
def comidas():
    ...
    titulo = Label(comidas, text="Times de futebol", foreground="#fff", background="#2c6b21", font=("Roboto", 30))
    titulo.pack(ipady=20)

    #quadro1 - parte a esquerda da janela

    quadro1 = Frame(comidas, background="#2c6b21", relief="solid", borderwidth=2)
    quadro1.place(x = 15, y = 150, width = 500, height = 500)
    ...
    quadro2 = Frame(comidas, background="#2c6b21", relief="solid", borderwidth=2)
    quadro2.place(x = 530, y = 150, width = 350, height = 500)
...
def Sobre():
    ...
    #Frame texto
    Frame_txt = Frame(sobre, background="#aad1fc", relief="solid", borderwidth=2)
    Frame_txt.place(x = 370, y = 100, width= 500, height= 400)
    #Parágrafos
    h1 = Label(Frame_txt,text="Obrigado!", font=("Montserrat", 30), background="#aad1fc")
    h1.pack(anchor="nw", padx=10, pady=20)
    p1 = Label(Frame_txt,text="Agradeço pelo interesse e pela avaliação do jogo", font=("Montserrat",16), background="#aad1fc")
    p1.pack(anchor="nw", padx=10)
    p2 = Label(Frame_txt,text="Desenvolvido por Rikelme Sousa de Carvalho", font=("Montserrat",16), background="#aad1fc")
